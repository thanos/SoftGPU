...
| Item | State | Notes |
| --- | --- | --- |
| macOS Apple Silicon + Rust 1.85 (`cargo test --workspace --locked`) | `verified-unit` | Phase 7 fast loop |
...
| SoftGPU Functional IR CPU execution | `verified-unit` | Phase 6–7; not gfx1201 ISA |
