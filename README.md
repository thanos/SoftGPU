...
> **v0.5.0 — Reproducible debugging beta (Phase 9):** SoftGPU Functional IR
> debugger (traces, breakpoints, seeded schedule exploration). This is **not**
> gfx1201 ISA emulation. See [docs/status.md](docs/status.md),
